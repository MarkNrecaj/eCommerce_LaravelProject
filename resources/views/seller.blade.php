                        ...
                        <div class="card-body">
                            <form method="POST" action="#">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control @error('state') eshte jo valide @enderror" name="state" value="{{ old('state') }}">
                                            ...
                                            <option value="Maccedonia">North Macedonia</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="quantity" type="number" class="form-control @error('quantity') eshte jo valide @enderror" name="quantity" value="{{ old('quantity') }}" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="price" type="number" class="form-control @error('price') eshte jo valide @enderror" name="price" value="{{ old('price') }}" autocomplete="off">
